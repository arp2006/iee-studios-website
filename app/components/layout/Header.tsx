...
export default function Header({ CALENDLY, lenisRef }: Props) {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 border-b border-black/50 bg-white/85 backdrop-blur-md">

      <div className="absolute lg:left-[70px] top-0 h-full w-px bg-black/50" />
